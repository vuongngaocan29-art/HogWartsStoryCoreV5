...
public class StoryManager {
    ...
    public void onSorted(Player player, House house) {
        ...
        Bukkit.getScheduler().runTaskLater(plugin, () -> {
            ...
            // Từ v0.4.0 không tự mở khoá Lumos sau Phân Loại.
            // Người chơi phải tới lớp của Flitwick, luyện bài rồi mới học vĩnh viễn.
            player.sendMessage(Msg.color("&e✦ Bài học đầu tiên: &fHãy tìm Giáo sư Flitwick để học Lumos."));
        }, 100L);
    }
    ...
    public boolean teachSpell(Player player, String spellId, boolean silentIfKnown) {
        ...
        // Điểm Nhà của bài học được trao bởi BetonQuest qua /hogwarts lessonreward.
        // Không cộng thêm tại đây để tránh nhận thưởng hai lần.
        return true;
    }
